                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{url('/admin/edit_about/'.$about->id)}}" name="edit_category" id="edit_category" novalidate="novalidate">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="desc" id="desc" cols="30" rows="10">{{$about->desc}}</textarea>
                                        <span id="chkPwd"></span>
                                    </div>
                                </div>
