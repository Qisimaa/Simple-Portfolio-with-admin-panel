                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/edit_team/'.$team->id)}}" name="edit_product" id="edit_prodcut" novalidate="novalidate">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="fb" id="fb" value="{{$team->facebook}}" />
                                        <span id="chkPwd"></span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="tw" id="tw" value="{{$team->twitter}}"/>
                                        <span id="chkPwd"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="google" id="google" value="{{$team->Googleplus}}"/>
                                        <span id="chkPwd"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <img src="{{asset('/images/back_end/team/large/'.$team->image)}}" style="width: 100px;height: 100px;">
                                        </div>
                                    </div>
