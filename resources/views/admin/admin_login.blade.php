...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/back_end/matrix-login.css')}}" />
    <link href="{{asset('fonts/back_end/font-awesome/css/font-awesome.css')}}" rel="stylesheet" />
...
@endif
    ...
    <form id="loginform" class="form-vertical" method="post" action="{{url('admin')}}"> {{ csrf_field() }}
        <div class="control-group normal_text"> <h3><img src="images/back_end/logo.png" alt="Logo" /></h3></div>
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
 <span class="add-on bg_lg"><i class="icon-user"> </i></span><input name="email" type="email" placeholder="Email" value="" required autofocus />
                </div>
            </div>
        </div>
        <div class="control-group">
